  ...
  <div class="player" v-show="playList.length>0">
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar :percent="percent" @percentChange="onPrgressBarChange"></progress-bar>
            </div>
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="openplayer">
        ...
        <div class="text">
          <h2 class="singer" v-html="currentSong.name"></h2>
...
export default {
  ...
  methods: {
    ...
    handleLyric({lineNum, txt}) {
      ...
      if (lineNum > 0 && lines[lineNum - 1].txt) {
